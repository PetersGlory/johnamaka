                ...
                <div className="group-2 w-full items-center justify-center">
                    ...
                    <center>
                        ...
                        <p className="element-specialise text-center mt-3 lg:w-[500px] font-[400]">
                            freely without any Issue to the wedding location
                        </p>

                    </center>
                    <div className="buttons mt-10">
                        <div className="flex flex-col md:flex-row items-center justify-evenly">
                        <Link href={"/"}><a href="#" className="btn btn-primary w-[300px] text-center p-3 bg-warning border border-white-800 text-white rounded">Return to Home</a></Link>
